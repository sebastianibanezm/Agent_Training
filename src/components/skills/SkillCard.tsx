      ...
      <div className="bg-[#161920] border border-[#1e2130] rounded-xl p-4 flex flex-col gap-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-1">
            ...
            <button onClick={() => setShowDelete(true)} className="p-1.5 text-slate-400 hover:text-white transition rounded" aria-label="Delete skill">
        ...
        {skill.trigger && (
          <p className="text-xs text-slate-400 line-clamp-1">{skill.trigger}</p>
        )}
